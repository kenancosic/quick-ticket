     ...
     <div className='min-h-screen bg-blue-50 p-8'>
      <div className='max-w-2xl mx-auto bg-white rounded-lg shadow border border-gray-200 p-8 space-y-6'>
        ...
        <div className='flex flex-col items-start justify-start'>
          <h2 className='text-lg font-semibold text-gray-700 mb-2'>Priority</h2>
          <span className={`px-3 py-1 inline-block rounded-full text-sm font-medium ${getPriorityClass(ticket.priority)}`}>
            {ticket.priority}
          </span>
        </div>
